...
class RE2 {
 ...
 public:
  ...
  class Options {
   public:
    ...
    //   minimize_mem_budget (false) minimize memory budget by removing forward
    //                               dfa memory.
    ...
    bool minimize_mem_budget() const { return minimize_mem_budget_; }
    void set_minimize_mem_budget(bool b) { minimize_mem_budget_ = b; }
 ...
 private:
  ...
  int64_t mem_budget_;            // total memory budget
