...
CMDLINES=\
	obj/cmdline/re2_minimized_mem_budget\
...
obj/cmdline/re2_minimized_mem_budget: obj/libre2.a obj/re2/cmdline/re2_minimized_mem_budget.o
	@mkdir -p obj/cmdline
	$(CXX) -o $@ obj/re2/cmdline/re2_minimized_mem_budget.o obj/libre2.a $(RE2_LDFLAGS) $(LDFLAGS)
